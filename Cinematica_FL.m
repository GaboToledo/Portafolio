...
P1_L=[53.3;87.8]; %Chasis-Amortiguador 
P2_L =[35.4;30.3]; %Bandeja-Chasis
L1_L = norm(P1_L - P2_L);
L2 = 25.867;
L3 = 18;
th1 = deg2rad(176.7);
...
for th2i = th2_range
    ...
    x0 = [deg2rad(180), deg2rad(180+153.8), 40];
...
sol(:,2) = rad2deg(sol(:,2))-188;  % Convert th3 to degrees
