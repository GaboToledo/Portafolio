...
P1_R=[-57.005;89.485]; %Chasis-Amortiguador 
P2_R =[-34.4;30]; %Bandeja-Chasis
L1_R = norm(P1_R - P2_R);
L2 = 25.867;
L3 = 18;
th1 = deg2rad(194.9);
th2_range = deg2rad(50:0.1:130);
...
for th2i = th2_range
    ...
    x0 = [deg2rad(100), deg2rad(100+170.1), 40];
    
    % Create anonymous function that passes fixed parameters
    fun = @(x) camper_system(x, th1, th2, L1_R, L2, L3);
...
sol(:,2) = rad2deg(sol(:,2))-186;  % Convert th3 to degrees
